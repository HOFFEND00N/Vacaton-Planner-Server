...
{
  public class VacationControllerDeclineVacation
  {
    ...
    public async void ShouldApproveVacation()
    {
      var expectedVacation = new Vacation
      {
        ...
        VacationState = VacationState.Declined
      };
      ...
      var response = await HttpClient.PutAsync($"employee/2/vacation/{createdVacation.Id}/decline", content);
